...
-- Дамп структуры базы данных s-mir
CREATE DATABASE IF NOT EXISTS `s-mir` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `s-mir`;


-- Дамп структуры для таблица s-mir.access
...
-- Дамп структуры для таблица s-mir.articles
...
-- Дамп данных таблицы s-mir.articles: ~1 rows (приблизительно)
/*!40000 ALTER TABLE `articles` DISABLE KEYS */;
INSERT IGNORE INTO `articles` (`id`, `created_at`, `updated_at`, `status`, `name`, `alias`, `text`, `h1`, `title`, `description`, `keywords`, `image`, `show_image`, `views`) VALUES
...
-- Дамп структуры для таблица s-mir.banners
...
INSERT IGNORE INTO `banners` (`id`, `created_at`, `updated_at`, `status`, `text`, `url`, `image`) VALUES
...
-- Дамп структуры для таблица s-mir.blacklist
...
-- Дамп структуры для таблица s-mir.blog
CREATE TABLE IF NOT EXISTS `blog` (
  ...
  CONSTRAINT `blog_ibfk_1` FOREIGN KEY (`rubric_id`) REFERENCES `blog_rubrics` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы s-mir.blog: ~7 rows (приблизительно)
/*!40000 ALTER TABLE `blog` DISABLE KEYS */;
INSERT IGNORE INTO `blog` (`id`, `created_at`, `updated_at`, `status`, `date`, `name`, `alias`, `text`, `image`, `h1`, `title`, `description`, `keywords`, `rubric_id`, `views`, `likes`, `type`) VALUES
...
-- Дамп структуры для таблица s-mir.blog_comments
CREATE TABLE IF NOT EXISTS `blog_comments` (
  ...
  CONSTRAINT `blog_comments_ibfk_1` FOREIGN KEY (`blog_id`) REFERENCES `blog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `blog_comments_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы s-mir.blog_comments: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `blog_comments` DISABLE KEYS */;
INSERT IGNORE INTO `blog_comments` (`id`, `created_at`, `updated_at`, `status`, `date`, `user_id`, `text`, `answer`, `blog_id`, `ip`, `name`, `date_answer`, `watched`) VALUES
...
-- Дамп структуры для таблица s-mir.blog_rubrics
...
INSERT IGNORE INTO `blog_rubrics` (`id`, `created_at`, `updated_at`, `sort`, `name`, `alias`, `text`, `h1`, `title`, `description`, `keywords`, `status`) VALUES
...
-- Дамп структуры для таблица s-mir.brands
...
INSERT IGNORE INTO `brands` (`id`, `created_at`, `updated_at`, `status`, `sort`, `name`, `text`, `alias`, `h1`, `title`, `description`, `keywords`, `views`, `image`) VALUES
...
-- Дамп структуры для таблица s-mir.callback
...
-- Дамп структуры для таблица s-mir.carts
...
-- Дамп данных таблицы s-mir.carts: ~1 rows (приблизительно)
/*!40000 ALTER TABLE `carts` DISABLE KEYS */;
INSERT IGNORE INTO `carts` (`id`, `created_at`, `updated_at`, `hash`) VALUES
	(2311, 1452932094, NULL, '28178664374f8119802e3b80b28c0fcd1a44353a');
/*!40000 ALTER TABLE `carts` ENABLE KEYS */;


-- Дамп структуры для таблица s-mir.carts_items
...
-- Дамп данных таблицы s-mir.carts_items: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `carts_items` DISABLE KEYS */;
INSERT IGNORE INTO `carts_items` (`id`, `cart_id`, `catalog_id`, `count`) VALUES
	(143, 2311, 45, 2),
	(144, 2311, 46, 4);
/*!40000 ALTER TABLE `carts_items` ENABLE KEYS */;


-- Дамп структуры для таблица s-mir.catalog
CREATE TABLE IF NOT EXISTS `catalog` (
  ...
  KEY `cat_brand_alias` (`brand_alias`),
  KEY `cat_model_alias` (`model_alias`),
  KEY `image_link` (`image`),
  CONSTRAINT `cat_brand_alias` FOREIGN KEY (`brand_alias`) REFERENCES `brands` (`alias`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `cat_model_alias` FOREIGN KEY (`model_alias`) REFERENCES `models` (`alias`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `image_link` FOREIGN KEY (`image`) REFERENCES `catalog_images` (`image`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `parent_id` FOREIGN KEY (`parent_id`) REFERENCES `catalog_tree` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы s-mir.catalog: ~16 rows (приблизительно)
/*!40000 ALTER TABLE `catalog` DISABLE KEYS */;
INSERT IGNORE INTO `catalog` (`id`, `created_at`, `updated_at`, `status`, `sort`, `name`, `alias`, `parent_id`, `new`, `sale`, `top`, `available`, `h1`, `title`, `keywords`, `description`, `text`, `characteristics`, `gallery`, `equipment`, `cost`, `cost_old`, `artikul`, `views`, `brand_alias`, `model_alias`, `image`) VALUES
	(40, 1447094647, 1447094912, 1, 1, 'Куртка Blend', 'kurtka-blend', 29, 1, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 2810, 0, '1', 1, 'benetton', NULL, '31c79213d5aceed90eed954307c44416.jpg'),
	(41, 1447094746, 1447094785, 1, 2, 'Brave Soul', 'brave-soul', 29, 0, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 2210, 0, '2', 0, 'next', NULL, '3faf38fccbe35f31b603141be04317f3.jpg'),
	(42, 1447094856, 1447094889, 1, 3, 's.Oliver', 'soliver', 29, 0, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 2310, 0, '3', 0, 'benetton', NULL, 'fe75cb26c4ae4c06af7d7fdef455fe1b.jpg'),
	(43, 1447095158, 1447096471, 1, 1, 'Mudo', 'mudo', 30, 0, 0, 0, 0, '', '', '', '', NULL, NULL, NULL, NULL, 312, 0, '4', 1, 'hm', NULL, '21f15ca55231a0db69dad9a2f1c6d2cd.jpg'),
	(44, 1447095265, 1447096467, 1, 2, 'Only & Sons', 'only--sons', 30, 0, 1, 0, 2, '', '', '', '', NULL, NULL, NULL, NULL, 820, 890, '5', 1, 'next', NULL, '43c658475e0a09cb4fc1c63b46bdc5a9.jpg'),
	(45, 1447095348, 1452938506, 1, 1, 'Top Secret', 'top-secret', 31, 0, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 950, 0, '6', 3, 'next', NULL, '7aaf1cc025af46186ef6105af07302aa.jpg'),
	(46, 1447095545, 1452951797, 1, 1, 'Patrol', 'patrol', 32, 0, 1, 0, 1, '', '', '', '', '<p>Описание<span class="r">&nbsp;</span></p>', '<p>Характеритики<span class="r">&nbsp;</span></p>', '<p>Строчки</p>', '<p>Комплектация<span class="r">&nbsp;</span></p>', 123, 1033, '7', 34, 'new-balance', '1300', '834516ecfadcc40ab5f028735db364d8.jpg'),
	(47, 1447095635, 1447095657, 1, 2, 'adidas Performance', 'adidas-performance', 32, 0, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 1270, 0, '8', 0, 'new-balance', '1400', 'eba914f0f9d25fa9b5b02a3df079aeb3.jpg'),
	(48, 1447095826, 1447096782, 1, 3, 'Reebok Classics', 'reebok-classics', 32, 1, 0, 1, 1, '', '', '', '', NULL, NULL, NULL, NULL, 1450, 0, '9', 1, 'nike', 'air-foamposite', '6200d3c32de330fdcd51b54374ec8c32.jpg'),
	(49, 1447095908, 1447095935, 1, 1, 'Burton Menswear London', 'burton-menswear-london', 33, 0, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 2860, 0, '10', 0, 'benetton', NULL, 'd56dbeb19c27a828e5762b1aabd956a2.jpg'),
	(50, 1447095980, 1447096008, 1, 1, 'Vitacci', 'vitacci', 34, 0, 0, 0, 2, '', '', '', '', NULL, NULL, NULL, NULL, 1300, 0, '11', 0, 'nike', 'air-jordan-', '782c69989db1782087e4db39a775339d.jpg'),
	(51, 1447096085, 1447096118, 1, 1, 'Quiksilver', 'quiksilver', 35, 0, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 1740, 0, '12', 0, 'hm', NULL, '528d7c85efd8247ba056e4a1c29b4bca.jpg'),
	(52, 1447096156, 1447096192, 1, 2, 'David Jones', 'david-jones', 35, 0, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 1500, 0, '13', 0, 'hm', NULL, '3e402891cdc71ca41bc7f7f09e042d4b.jpg'),
	(53, 1447096237, 1452950110, 1, 3, 'A-Personality', 'a-personality', 35, 0, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 400, 0, '14', 2, 'benetton', NULL, 'ffeee2baa0eb681477b1b4ae95c92e79.jpg'),
	(54, 1447096327, 1447096358, 1, 1, 'Oakley', 'oakley', 36, 0, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 1701, 0, '15', 0, 'hm', NULL, 'fd180a4c7b269eff9987c17be93ed57f.jpg'),
	(55, 1447096428, 1447096441, 1, 2, 'Polaroid', 'polaroid', 36, 0, 0, 0, 1, '', '', '', '', NULL, NULL, NULL, NULL, 756, 0, '16', 0, 'hm', NULL, '535707cf9761cf5dda7b4b8cfa8412d9.jpg');
/*!40000 ALTER TABLE `catalog` ENABLE KEYS */;


-- Дамп структуры для таблица s-mir.catalog_comments
...
-- Дамп структуры для таблица s-mir.catalog_images
...
INSERT IGNORE INTO `catalog_images` (`id`, `created_at`, `updated_at`, `sort`, `catalog_id`, `main`, `image`) VALUES
...
-- Дамп структуры для таблица s-mir.catalog_questions
...
-- Дамп структуры для таблица s-mir.catalog_related
...
INSERT IGNORE INTO `catalog_related` (`id`, `who_id`, `with_id`) VALUES
	(41, 41, 40),
	(42, 42, 40),
	(43, 42, 41);
...
-- Дамп структуры для таблица s-mir.catalog_specifications_values
CREATE TABLE IF NOT EXISTS `catalog_specifications_values` (
  ...
  PRIMARY KEY (`id`),
  KEY `catalog_id` (`catalog_id`) USING BTREE,
  KEY `spec_alias` (`specification_alias`),
  KEY `spec_val_alias` (`specification_value_alias`),
  ...
  CONSTRAINT `spec_alias` FOREIGN KEY (`specification_alias`) REFERENCES `specifications` (`alias`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `spec_val_alias` FOREIGN KEY (`specification_value_alias`) REFERENCES `specifications_values` (`alias`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT IGNORE INTO `catalog_specifications_values` (`id`, `catalog_id`, `specification_value_alias`, `specification_alias`) VALUES
	...
	(240, 54, 'polimer', 'material'),
	(241, 54, 'uniseks', 'sex'),
	(242, 54, 'vetnam', 'proizvodstvo'),
	(243, 54, 'leto', 'sezon'),
	(244, 54, 'korichnevyj', 'tsvet'),
...
-- Дамп структуры для таблица s-mir.catalog_tree
...
INSERT IGNORE INTO `catalog_tree` (`id`, `created_at`, `updated_at`, `status`, `sort`, `name`, `alias`, `parent_id`, `image`, `h1`, `title`, `keywords`, `description`, `text`, `views`) VALUES
	(26, 1447093601, 1452948841, 1, 0, 'Одежда', 'odezhda', 0, 'f14ee130921e60bb75602d2707c4739f.jpg', '', '', '', '', '', 11),
	(27, 1447093637, 1452949029, 1, 6, 'Обувь', 'obuv', 0, '8f8f36d63e317825d5e1edfd8d075f83.jpg', '', '', '', '', '', 1),
	(28, 1447093670, 1452936294, 1, 8, 'Аксессуары', 'aksessuary', 0, '09a2324dbaac9188f59a757813092cb0.jpg', '', '', '', '', '', 0),
	(29, 1447093805, 1452949036, 1, 3, 'Верхняя одежда', 'verhnjaja-odezhda', 0, 'ec2be2aacbdc7ff22fa118fa4eddfe47.jpg', '', '', '', '', '', 29),
	(30, 1447093854, 1452949038, 1, 2, 'Рубашки', 'rubashki', 0, '9aac3ade273a7cad5fb4902617d809f8.jpg', '', '', '', '', '', 3),
	(31, 1447093893, 1452947544, 1, 1, 'Джинсы', 'dzhinsy', 0, '1beda7e91b7a47dfd978d13256c698db.png', '', '', '', '', '', 3),
	(32, 1447093942, 1452949020, 1, 7, 'Кроссовки', 'krossovki', 0, '6227fc9615898a617aa48711effe7680.jpg', '', '', '', '', '', 24),
	(33, 1447093982, 1452936294, 1, 5, 'Туфли', 'tufli', 0, 'b06349dbd853de3031d9badbbe351841.jpeg', '', '', '', '', '', 0),
	(34, 1447094016, 1452947563, 1, 4, 'Мокасины', 'mokasiny', 0, 'adaa76210381b3db6eec65c764a34ec8.jpg', '', '', '', '', '', 1),
	(35, 1447094058, 1452949047, 1, 10, 'Сумки', 'sumki', 0, 'a722cded1894ae53dfa4dddc32161678.jpg', '', '', '', '', '', 1),
	(36, 1447094096, 1452949042, 1, 9, 'Очки', 'ochki', 0, '30864db826139a5a2669e15d71eed076.jpg', '', '', '', '', '', 1);
/*!40000 ALTER TABLE `catalog_tree` ENABLE KEYS */;


-- Дамп структуры для таблица s-mir.catalog_tree_brands
...
-- Дамп данных таблицы s-mir.catalog_tree_brands: ~24 rows (приблизительно)
/*!40000 ALTER TABLE `catalog_tree_brands` DISABLE KEYS */;
INSERT IGNORE INTO `catalog_tree_brands` (`id`, `brand_id`, `catalog_tree_id`) VALUES
	(291, 31, 29),
	(292, 32, 29),
	(293, 33, 29),
	(294, 31, 30),
...
-- Дамп структуры для таблица s-mir.catalog_tree_specifications
...
INSERT IGNORE INTO `catalog_tree_specifications` (`id`, `catalog_tree_id`, `specification_id`) VALUES
	(202, 29, 19),
	(203, 29, 23),
	(204, 29, 20),
	(205, 29, 21),
...
-- Дамп структуры для таблица s-mir.config
...
INSERT IGNORE INTO `config` (`id`, `name`, `zna`, `updated_at`, `status`, `sort`, `key`, `valid`, `type`, `values`, `group`) VALUES
	...
	(7, 'Количество товаров на странице', '20', 1434885560, 1, 7, 'limit', 1, 'input', NULL, 'basic'),
	...
	(11, 'FB.com', 'http://fb.com', 1434885560, 1, 11, 'fb', 0, 'input', NULL, 'socials'),
	...
	(17, 'Количество новостей / статей на странице', '10', 1434885560, 1, 7, 'limit_articles', 1, 'input', NULL, 'basic'),
...
-- Дамп структуры для таблица s-mir.config_groups
...
INSERT IGNORE INTO `config_groups` (`id`, `name`, `alias`, `side`, `status`, `sort`) VALUES
...
-- Дамп структуры для таблица s-mir.config_types
...
INSERT IGNORE INTO `config_types` (`id`, `name`, `alias`) VALUES
...
-- Дамп структуры для таблица s-mir.contacts
...
-- Дамп данных таблицы s-mir.contacts: ~2 rows (приблизительно)
/*!40000 ALTER TABLE `contacts` DISABLE KEYS */;
INSERT IGNORE INTO `contacts` (`id`, `created_at`, `updated_at`, `status`, `name`, `email`, `text`, `ip`) VALUES
	(14, 1452942994, NULL, 1, 'фыв', 'procivam@gmail.com', 'aoeuaoeuaoа', '127.0.0.1'),
	(15, 1452943285, NULL, 1, 'ae', 'wezom@gmail.com', 'euo', '127.0.0.1');
/*!40000 ALTER TABLE `contacts` ENABLE KEYS */;


-- Дамп структуры для таблица s-mir.content
...
-- Дамп данных таблицы s-mir.content: ~3 rows (приблизительно)
/*!40000 ALTER TABLE `content` DISABLE KEYS */;
INSERT IGNORE INTO `content` (`id`, `name`, `alias`, `title`, `description`, `keywords`, `text`, `status`, `created_at`, `h1`, `updated_at`, `sort`, `parent_id`, `class`, `views`) VALUES
...
-- Дамп структуры для таблица s-mir.control
...
INSERT IGNORE INTO `control` (`id`, `name`, `h1`, `title`, `keywords`, `description`, `text`, `alias`, `status`, `other`) VALUES
	...
	(3, 'Статьи', 'Статьи', 'Статьи', 'Статьи', 'Статьи', NULL, 'articles', 1, NULL),
	(4, 'Корзина', 'Корзина', 'Корзина', 'Корзина', 'Корзина', NULL, 'cart', 1, NULL),
	(5, 'Новости', 'Новости', 'Новости', 'Новости', 'Новости', NULL, 'news', 1, NULL),
	(6, 'Поиск', 'Поиск', 'Поиск', 'Поиск', 'Поиск', NULL, 'search', 1, NULL),
	(7, 'Карта сайта', 'Карта сайта', 'Карта сайта', 'Карта сайта', 'Карта сайта', NULL, 'sitemap', 1, NULL),
	(8, 'Производители', 'Производители', 'Производители', 'Производители', 'Производители', NULL, 'brands', 1, NULL),
	(9, 'Каталог продукции', 'Каталог', 'Каталог', 'Каталог', 'Каталог', NULL, 'catalog', 1, NULL),
	(10, 'Популярные', 'Популярные товары', 'Популярные товары', 'Популярные товары', 'Популярные товары', NULL, 'popular', 1, NULL),
	(11, 'Новинки', 'Новинки', 'Новинки', 'Новинки', 'Новинки', NULL, 'new', 1, NULL),
	(12, 'Акции', 'Акции', 'Акции', 'Акции', 'Акции', '', 'sale', 1, NULL),
	(13, 'Просмотренные', 'Просмотренные', 'Просмотренные', 'Просмотренные', 'Просмотренные', NULL, 'viewed', 1, NULL);
/*!40000 ALTER TABLE `control` ENABLE KEYS */;


-- Дамп структуры для таблица s-mir.cron
...
-- Дамп структуры для таблица s-mir.gallery
...
INSERT IGNORE INTO `gallery` (`id`, `created_at`, `updated_at`, `status`, `name`, `image`, `h1`, `title`, `keywords`, `description`, `alias`, `text`, `sort`) VALUES
...
-- Дамп структуры для таблица s-mir.gallery_images
...
INSERT IGNORE INTO `gallery_images` (`id`, `created_at`, `updated_at`, `image`, `main`, `gallery_id`, `sort`) VALUES
...
-- Дамп структуры для таблица s-mir.log
...
-- Дамп данных таблицы s-mir.log: ~4 rows (приблизительно)
/*!40000 ALTER TABLE `log` DISABLE KEYS */;
INSERT IGNORE INTO `log` (`id`, `created_at`, `updated_at`, `name`, `link`, `ip`, `deleted`, `type`, `status`) VALUES
...
-- Дамп структуры для таблица s-mir.mail_templates
...
INSERT IGNORE INTO `menu` (`id`, `id_parent`, `name`, `link`, `sort`, `id_content`, `created_at`, `status`, `image`, `updated_at`, `icon`, `count`) VALUES
	...
	(22, 5, 'Список статей', 'articles/index', 6, 0, NULL, 1, NULL, NULL, NULL, NULL),
	(23, 5, 'Добавить статью', 'articles/add', 7, 0, NULL, 1, NULL, NULL, NULL, NULL),
...
-- Дамп структуры для таблица s-mir.models
CREATE TABLE IF NOT EXISTS `models` (
  ...
  PRIMARY KEY (`id`),
  KEY `alias` (`alias`),
  KEY `model_brand_alias` (`brand_alias`),
  CONSTRAINT `model_brand_alias` FOREIGN KEY (`brand_alias`) REFERENCES `brands` (`alias`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы s-mir.models: ~8 rows (приблизительно)
/*!40000 ALTER TABLE `models` DISABLE KEYS */;
INSERT IGNORE INTO `models` (`id`, `created_at`, `updated_at`, `status`, `name`, `alias`, `brand_alias`) VALUES
...
-- Дамп структуры для таблица s-mir.news
...
-- Дамп данных таблицы s-mir.orders: ~1 rows (приблизительно)
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT IGNORE INTO `orders` (`id`, `created_at`, `updated_at`, `status`, `payment`, `delivery`, `name`, `phone`, `user_id`, `ip`, `last_name`, `middle_name`, `email`, `done`, `changed`) VALUES
	(53, 1447096883, NULL, 0, 1, 1, 'Томпсон Валера', '+38 (234) 234-23-42', 21, '127.0.0.1', NULL, NULL, NULL, NULL, 0);
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;


-- Дамп структуры для таблица s-mir.orders_items
CREATE TABLE IF NOT EXISTS `orders_items` (
  ...
  CONSTRAINT `orders_items_ibfk_2` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы s-mir.orders_items: ~1 rows (приблизительно)
/*!40000 ALTER TABLE `orders_items` DISABLE KEYS */;
INSERT IGNORE INTO `orders_items` (`id`, `order_id`, `catalog_id`, `size_id`, `cost`, `count`) VALUES
	(84, 53, 48, 0, 1450, 2);
/*!40000 ALTER TABLE `orders_items` ENABLE KEYS */;


-- Дамп структуры для таблица s-mir.orders_simple
CREATE TABLE IF NOT EXISTS `orders_simple` (
  ...
  PRIMARY KEY (`id`),
  KEY `catalog_id` (`catalog_id`) USING BTREE,
  CONSTRAINT `orders_simple_ibfk_1` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы s-mir.orders_simple: ~1 rows (приблизительно)
/*!40000 ALTER TABLE `orders_simple` DISABLE KEYS */;
INSERT IGNORE INTO `orders_simple` (`id`, `created_at`, `updated_at`, `status`, `phone`, `ip`, `catalog_id`, `user_id`) VALUES
	(20, 1447096946, NULL, 0, '+38 (111) 111-11-11', '127.0.0.1', 40, 21);
/*!40000 ALTER TABLE `orders_simple` ENABLE KEYS */;


-- Дамп структуры для таблица s-mir.popup_messages
...
INSERT IGNORE INTO `popup_messages` (`id`, `name`, `ru`, `updated_at`) VALUES
...
-- Дамп структуры для таблица s-mir.reviews
...
-- Дамп структуры для таблица s-mir.seo_links
...
-- Дамп структуры для таблица s-mir.seo_redirects
...
-- Дамп структуры для таблица s-mir.seo_scripts
...
-- Дамп структуры для таблица s-mir.seo_templates
...
INSERT IGNORE INTO `seo_templates` (`id`, `name`, `h1`, `title`, `description`, `keywords`, `updated_at`) VALUES
...
-- Дамп структуры для таблица s-mir.sitemenu
...
INSERT IGNORE INTO `sitemenu` (`id`, `created_at`, `updated_at`, `status`, `sort`, `name`, `url`) VALUES
...
-- Дамп структуры для таблица s-mir.slider
...
INSERT IGNORE INTO `slider` (`id`, `created_at`, `updated_at`, `status`, `sort`, `name`, `text`, `url`, `image`) VALUES
...
-- Дамп структуры для таблица s-mir.specifications
...
INSERT IGNORE INTO `specifications` (`id`, `created_at`, `updated_at`, `status`, `name`, `alias`, `type_id`) VALUES
...
-- Дамп структуры для таблица s-mir.specifications_types
...
INSERT IGNORE INTO `specifications_types` (`id`, `name`) VALUES
	(1, 'Цвет'),
	(2, 'Обычная'),
	(3, 'Мультивыбор');
...
-- Дамп структуры для таблица s-mir.specifications_values
...
INSERT IGNORE INTO `specifications_values` (`id`, `created_at`, `updated_at`, `status`, `name`, `alias`, `specification_id`, `color`) VALUES
...
-- Дамп структуры для таблица s-mir.subscribers
...
-- Дамп структуры для таблица s-mir.subscribe_mails
...
-- Дамп структуры для таблица s-mir.users
...
INSERT IGNORE INTO `users` (`id`, `name`, `login`, `password`, `created_at`, `updated_at`, `hash`, `email`, `status`, `role_id`, `ip`, `phone`, `last_login`, `logins`, `last_name`, `middle_name`) VALUES
...
-- Дамп структуры для таблица s-mir.users_networks
...
INSERT IGNORE INTO `users_networks` (`id`, `user_id`, `network`, `created_at`, `uid`, `profile`, `first_name`, `last_name`, `email`) VALUES
...
-- Дамп структуры для таблица s-mir.users_roles
...
INSERT IGNORE INTO `users_roles` (`id`, `name`, `description`, `alias`, `created_at`, `updated_at`) VALUES
...
-- Дамп структуры для таблица s-mir.visitors
...
-- Дамп данных таблицы s-mir.visitors: ~52 rows (приблизительно)
/*!40000 ALTER TABLE `visitors` DISABLE KEYS */;
INSERT IGNORE INTO `visitors` (`id`, `ip`, `country`, `region`, `city`, `longitude`, `latitude`, `answer`, `first_enter`, `last_enter`, `enters`) VALUES
...
-- Дамп структуры для таблица s-mir.visitors_hits
CREATE TABLE IF NOT EXISTS `visitors_hits` (
  ...
  CONSTRAINT `visitors_hits_ibfk_1` FOREIGN KEY (`ip`) REFERENCES `visitors` (`ip`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3083 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы s-mir.visitors_hits: ~3 168 rows (приблизительно)
/*!40000 ALTER TABLE `visitors_hits` DISABLE KEYS */;
INSERT IGNORE INTO `visitors_hits` (`id`, `ip`, `url`, `created_at`, `updated_at`, `status`, `device`, `useragent`, `counter`) VALUES
...
-- Дамп структуры для таблица s-mir.visitors_referers
CREATE TABLE IF NOT EXISTS `visitors_referers` (
  ...
  PRIMARY KEY (`id`),
  KEY `ip` (`ip`) USING BTREE,
  CONSTRAINT `visitors_referers_ibfk_1` FOREIGN KEY (`ip`) REFERENCES `visitors` (`ip`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы s-mir.visitors_referers: ~3 rows (приблизительно)
/*!40000 ALTER TABLE `visitors_referers` DISABLE KEYS */;
INSERT IGNORE INTO `visitors_referers` (`id`, `ip`, `url`, `created_at`) VALUES
