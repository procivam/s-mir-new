        ...
        <div class="widget box">
            ...
            <div class="widgetContent">
                <div class="form-vertical row-border">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="f_group">Рубрика</label>
                        <div class="">
                            <div class="controls">
                                <select id="f_group" class="form-control valid" name="FORM[rubric_id]">
                                    <?php foreach( $rubrics AS $value ): ?>
                                        <option value="<?php echo $value->id; ?>" <?php echo $value->id == $obj->rubric_id ? 'selected' : NULL; ?>><?php echo $value->name; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <?php if (is_file( HOST . Core\HTML::media('images/blog/big/'.$obj->image) )): ?>
                                <a href="<?php echo Core\HTML::media('images/blog/big/'.$obj->image); ?>" rel="lightbox">
                                ...
                                <br />
                                <a href="<?php echo \Core\General::crop('blog', 'small', $obj->image); ?>">Редактировать</a>
                            <?php else: ?>
