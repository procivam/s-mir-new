            ...
            <tbody>
                <?php foreach ( $list as $obj ): ?>
                    <tr data-id="<?php echo $obj->id; ?>">
                        ...
                        <td class="align-center"><input <?php echo (\Core\User::god() || \Core\User::caccess() == 'edit') ?: 'disabled' ?> type="text" class="form-control sColor hue" value="<?php echo $obj->color; ?>" /></td>
                        <td class="align-center  <?php echo !(\Core\User::god() || \Core\User::caccess() == 'edit') ?: 'input-group' ?>">
                            <input <?php echo (\Core\User::god() || \Core\User::caccess() == 'edit') ?: 'disabled' ?> class="form-control sAlias translitConteiner" data-trans="<?php echo 'val-'.$obj->id; ?>" type="text" value="<?php echo $obj->alias; ?>" />
                            <?php if(\Core\User::god() || \Core\User::caccess() == 'edit'): ?>
                                <span class="input-group-btn">
