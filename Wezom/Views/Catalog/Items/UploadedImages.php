            ...
            <div class="loadedBlock <?= $im->status == 1 ? 'chk' : ''; ?>" data-image="<?=$im->id; ?>">
                ...
                <div class="loadedControl">
                    <?php if(\Core\User::god() || \Core\User::get_access_for_controller('items') == 'edit'): ?>
                        <div class="loadedCtrl loadedCover">
                            <label>
                                ...
                                <ins></ins>
                                <span class="btn btn-success" alt="Обложка"><i class="fa-bookmark-empty"></i></span>
                    ...
                    <div class="loadedCtrl loadedView">
                        <button class="btn btn-primary btnImage" alt="Просмотр" href="<?php echo Core\HTML::media('images/catalog/big/'.$im->image); ?>"><i class="fa-zoom-in"></i></button>
                    </div>
                    <?php if(\Core\User::god() || \Core\User::get_access_for_controller('items') == 'edit'): ?>
                        <div class="loadedCtrl">
                            <button class="btn btn-warning" alt="Редактировать" href="<?php echo \Core\General::crop('catalog', 'small', $im->image, $_SERVER['HTTP_REFERER']); ?>"><i class="fa-pencil"></i></button>
                        </div>
