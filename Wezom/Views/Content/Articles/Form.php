                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <?php if (is_file( HOST.\Core\HTML::media('images/articles/original/'.$obj->image) )): ?>
                                <a href="<?php echo \Core\HTML::media('images/articles/original/'.$obj->image); ?>" rel="lightbox">
                                ...
                                <br />
                                <a href="<?php echo \Core\General::crop('articles', 'small', $obj->image); ?>">Редактировать</a>
                            <?php else: ?>
