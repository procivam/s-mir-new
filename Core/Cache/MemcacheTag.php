    ...
    * @license    http://kohanaphp.com/license
    ...
    class MemcacheTag extends Memcache implements Tagging {
        ...
        protected function __construct(array $config)
        {
            ...
            {
                die('Memcached-tags PHP plugin not present. Please see http://code.google.com/p/memcached-tags/ for more information');
            }
        }
        ...
        {
            die('Memcached-tags does not support finding by tag');
        }
    }
