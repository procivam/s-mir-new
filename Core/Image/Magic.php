<?php
    ...
    class Magic extends Image {
        ...
        public static function check()
        {
            ...
            {
                die('Imagick is not installed, or the extension is not loaded');
            }

            return Magic::$_checked = TRUE;
        }
        ...
        protected function _get_imagetype($extension)
        {
            ...
            switch ($format)
            {
                ...
                break;
                default:
                    die('Installed ImageMagick does not support '.$extension.' images');
                break;
            }
