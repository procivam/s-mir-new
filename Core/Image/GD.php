<?php
    ...
    class GD extends Image {
        ...
        public function __construct($file)
        {
            ...
            {
                die('Installed GD does not support '.image_type_to_extension($this->type, FALSE).' images');
            }
        ...
        protected function _do_rotate($degrees)
        {
            ...
            {
                die('This method requires "imagerotate", which is only available in the bundled version of GD');
            }
        ...
        protected function _do_sharpen($amount)
        {
            ...
            {
                die('This method requires "imageconvolution, which is only available in the bundled version of GD');
            }
        ...
        protected function _do_reflection($height, $opacity, $fade_in)
        {
            ...
            {
                die('This method requires "imagefilter", which is only available in the bundled version of GD');
            }
        ...
        protected function _save_function($extension, & $quality)
        {
            ...
            switch (strtolower($extension))
            {
                ...
                break;
                default:
                    die('Installed GD does not support '.$extension.' images');
                break;
            }
