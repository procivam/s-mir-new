...
<th width="250" align="left">whois</th>
<th width="110" align="left">Цена</th>
<th width="110" align="left">Продление</th>
...
<td align="left" width="110" nowrap><nobr><input type="text" name="price_extend_{$items[i].id}" style="width:80px" size="8" value="{$items[i].price_extend|round:2}"><span class="gray">&nbsp;{$options.valute}</span></nobr></td>
