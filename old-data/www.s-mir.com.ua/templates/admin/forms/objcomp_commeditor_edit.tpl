<form name="editcommentform" method="post" onsubmit="return comment_form(this)">
<p>Имя:<sup style="color:gray">*</sup></p>
<p>{editbox name="name" width="40%" text=$form.name tabindex="1"}</p>
<p>&nbsp;</p>
...
{hidden name="iditem" value=$form.iditem}
{hidden name="mode" value=$system.mode}
{hidden name="item" value=$system.item}
{hidden name="obj_action" value="comm_edit"}
{hidden name="authcode" value=$system.authcode}
<div align="right" style="margin-top:10px">
<p style="float:left"><label><input type="checkbox" name="active"{if $form.active=="Y"} checked{/if}>&nbsp;Размещен</label></p>
