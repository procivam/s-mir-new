...
{if $options.useorder}
{tabcontrol items="Записи" comm="Комментарии" orders="Заказы" import="Импорт/Экспорт" opt="Настройки"}
{else}
{tabcontrol items="Записи" comm="Комментарии" import="Импорт/Экспорт" opt="Настройки"}
{/if}
{else}
{if $options.useorder}
{tabcontrol items="Записи" orders="Заказы" import="Импорт/Экспорт" opt="Настройки"}
{else}
...
<th width="100" align="center">Оплачен</th>
...
<td width="100" align="center">{if $items[i].sold=='Y'}Да{else}Нет{/if}</td>
