...
{else}
<li><img class="bgimg" src="/templates/admin/images/bg_l_menu_act.png"><a class="cp_link_headding_leftmenu" href="admin.php?mode={$system.mode}&item={$menuitem.item}" title="{$menuitem.name}">{$menuitem.name|truncate:18:"...":true}</a></li>
{/if}
</ul>
</td>
</tr>
