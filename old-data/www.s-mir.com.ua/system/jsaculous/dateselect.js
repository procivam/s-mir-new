...
CalendarDateSelect.prototype = {
  ...
  initButtonsDiv: function()
  {
    ...
    if (this.options.get("time"))
    {
      ...
      buttons_div.build("span", {innerHTML:"Время ", className: "at_sign"});
  ...
  updateValue: function() {
	...
	if(this.options.get("maxtime"))
	this.selected_date.setHours(23,59,59);
	this.target_element.previous().value = this.selected_date.valueOf()/1000;
...
Date.parseFormattedString = function (string) {
  ...
  if (d==null) return Date.parse(string);
  var offset = 0;
