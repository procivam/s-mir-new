...
<ul class="page">
    <li class="ots"><a href="<?php echo $this->_tpl_vars['prevlink']; ?>
" class="but3">Предыдущая</a></li>
...
?>
	<?php if ($this->_tpl_vars['pagelinks'][$this->_sections['i']['index']]['selected']): ?>
		<li class="active"><a href="<?php echo $this->_tpl_vars['pagelinks'][$this->_sections['i']['index']]['link']; ?>
"><?php echo $this->_tpl_vars['pagelinks'][$this->_sections['i']['index']]['name']; ?>
</a></li>
	<?php else: ?>
		<li ><a href="<?php echo $this->_tpl_vars['pagelinks'][$this->_sections['i']['index']]['link']; ?>
"><?php echo $this->_tpl_vars['pagelinks'][$this->_sections['i']['index']]['name']; ?>
</a></li>
	<?php endif; ?>
  <?php endfor; endif; ?>
    <li class="ots2"><a href="<?php echo $this->_tpl_vars['nextlink']; ?>
" class="but3">Следующая</a></li>
