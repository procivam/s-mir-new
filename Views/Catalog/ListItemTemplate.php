<li class="list-item">
    <a href="<?php echo Core\HTML::link($obj->alias.'/p'.$obj->id, true); ?>" class="img_tovar">
    ...
    <a href="<?php echo Core\HTML::link($obj->alias.'/p'.$obj->id, true); ?>" class="tovar_name"><span><?php echo $obj->name; ?></span></a>
    ...
    <a href="<?php echo Core\HTML::link($obj->alias.'/p'.$obj->id, true); ?>" data-id="<?php echo $obj->id; ?>" class="bye addToCart"><span>Купить</span></a>
</li>
